...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/started hadoop.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hdfs_screenshot..png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/mr_execution1.png}
    \caption{Compiling MapReduce Java code and packaging the JAR executable.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/mr_execution2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/mr_output.png}
...
\subsection{Query 1: SELECT}
\textbf{Retrieve the first 10 crime records.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq1.png}
    \caption{Execution result for Query 1 (SELECT).}
\end{figure}

\subsection{Query 2: WHERE}
\textbf{Find all incidents where an arrest was made for narcotics.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq2.png}
    \caption{Execution result for Query 2 (WHERE).}
\end{figure}

\subsection{Query 3: ORDER BY}
\textbf{List recent homicides ordered by date.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hive1.png}
    \caption{Execution result for Query 3 (ORDER BY).}
\end{figure}

\subsection{Query 4: GROUP BY \& COUNT}
\textbf{Find the number of crimes per location description.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq4.png}
    \caption{Execution result for Query 4 (GROUP BY \& COUNT).}
\end{figure}

\subsection{Query 5: HAVING}
\textbf{Find primary crime types that occurred more than 500 times.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq5.png}
    \caption{Execution result for Query 5 (HAVING).}
\end{figure}

\subsection{Query 6: SUM}
\textbf{Calculate the total number of arrests made per district.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq6.png}
    \caption{Execution result for Query 6 (SUM).}
\end{figure}

\subsection{Query 7: AVG}
\textbf{Calculate the average number of domestic crimes per beat.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq7.png}
    \caption{Execution result for Query 7 (AVG).}
\end{figure}

\subsection{Query 8: MAX}
\textbf{Find the district with the maximum reported cases.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq8.png}
    \caption{Execution result for Query 8 (MAX).}
\end{figure}

\subsection{Query 9: MIN}
\textbf{Find the district with the minimum reported cases.}
\begin{lstlisting}[language=SQL]
SELECT district, COUNT(*) AS district_total
FROM crimes WHERE district IS NOT NULL AND district != ''
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq9.png}
    \caption{Execution result for Query 9 (MIN).}
\end{figure}

\subsection{Query 10: JOIN}
\textbf{Join crimes and community\_areas to display community names.}
\begin{lstlisting}[language=SQL]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{new_img/hiveq10.png}

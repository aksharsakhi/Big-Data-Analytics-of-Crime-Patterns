...
\begin{frame}{Dataset Overview}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textcolor{NavyBlue}{Identifiers:} \texttt{id}, \texttt{case\_number}, \texttt{date}
            \item \textcolor{NavyBlue}{Categories:} \texttt{primary\_type}, \texttt{description}
            \item \textcolor{NavyBlue}{Location:} \texttt{district}, \texttt{ward}, \texttt{community\_area}
            \item \textcolor{NavyBlue}{Flags:} \texttt{arrest}, \texttt{domestic}
        \end{itemize}
    \end{itemize}
\end{frame}
